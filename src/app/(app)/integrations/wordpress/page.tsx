...
export default function WordPressIntegrationPage() {
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      {/* Download card */}
      <div className="bg-gradient-to-br from-slate-950/40 to-slate-900 border border-slate-700/30 rounded-2xl p-6 mb-6 flex items-center gap-6">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex gap-3 mt-2">
            {['Chat Widget', 'Post Sync', 'Lead Capture', 'Dashboard Widget'].map(f => (
              <span key={f} className="flex items-center gap-1 text-xs text-blue-400">
        ...
        <a
          ...
          download="coovex.php"
          className="flex items-center gap-2 px-5 py-3 bg-blue-600 hover:bg-blue-500 text-white text-sm font-medium rounded-xl transition-colors flex-shrink-0"
        >
        ...
        <div className="space-y-4">
          {STEPS.map(s => (
            <div key={s.step} className="flex gap-4">
              <div className="w-7 h-7 rounded-full bg-blue-600/20 border border-slate-700/40 text-blue-400 text-xs font-bold flex items-center justify-center flex-shrink-0 mt-0.5">
                {s.step}
              </div>
              <div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-5">
        ...
        <div className="space-y-2">
          <div className="bg-slate-950 rounded-lg p-3 font-mono text-sm text-blue-300">[coovex_chat]</div>
          <div className="bg-slate-950 rounded-lg p-3 font-mono text-sm text-blue-300">[coovex_chat width=&quot;400&quot; height=&quot;600&quot;]</div>
        </div>
