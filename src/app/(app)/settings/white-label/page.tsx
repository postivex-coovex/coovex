...
const COLORS = ['#7c3aed', '#2563eb', '#059669', '#d97706', '#dc2626', '#0891b2', '#ec4899']
...
export default function WhiteLabelPage() {
  ...
  return (
    <div className="p-6 max-w-3xl">
      ...
      {/* Portal URL */}
      {portalUrl && (
        <div className="bg-emerald-950/20 border border-emerald-800/30 rounded-xl p-4 mb-6 flex items-center gap-3">
          <div className="flex-1 min-w-0">
            <p className="text-emerald-400 text-xs font-semibold mb-0.5">Your Client Portal URL</p>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-4">
          ...
          <div className="flex items-center justify-between py-1">
            ...
            <button
              ...
              className={`w-11 h-6 rounded-full transition-colors relative ${config.portal_enabled ? 'bg-violet-600' : 'bg-slate-700'}`}
            >
          ...
          <div className="flex items-center justify-between py-1">
            ...
            <button
              ...
              className={`w-11 h-6 rounded-full transition-colors relative ${config.hide_powered_by ? 'bg-violet-600' : 'bg-slate-700'}`}
            >
