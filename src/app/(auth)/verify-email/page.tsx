...
export default function VerifyEmailPage() {
  return (
    <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-8 text-center">
      <div className="w-16 h-16 rounded-full bg-blue-600/20 border border-blue-500/30 flex items-center justify-center mx-auto mb-5 text-3xl">
        📧
      </div>
      ...
      <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-4 mb-6">
        <p className="text-slate-400 text-xs leading-relaxed">
          ...
          The sender is <span className="text-blue-400">noreply@coovex.com</span>.
        </p>
      </div>
      ...
      <div className="space-y-3">
        <Link
          href="/login"
          className="block w-full bg-blue-600 hover:bg-blue-500 text-white text-sm font-semibold py-2.5 rounded-xl transition-colors"
        >
          Go to Login →
        </Link>
        <Link
