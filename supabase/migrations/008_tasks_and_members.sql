...
CREATE TABLE support_property_members (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX idx_spm_property_id ON support_property_members(property_id);
CREATE INDEX idx_spm_member_email ON support_property_members(member_email);
CREATE INDEX idx_spm_member_user_id ON support_property_members(member_user_id);
